...
public:
	...
	void DrawWireFrame(triangle t, COLOUR color)
	{
		DrawTriangle(t.p[0].x, t.p[0].y, t.p[1].x, t.p[1].y, t.p[2].x, t.p[2].y, PIXEL_SOLID, color);
	}
...
private:
    ...
    mat4x4 Matrix_PointAt(vec3d &pos, vec3d &target, vec3d &up)
    {
        ...
        // New right direction us easy, its just cross product
...
{
    Engine3D demo;
    if (demo.ConstructConsole(480, 254, 4, 4));
        demo.Start();
    return 0;
